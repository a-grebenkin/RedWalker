    ...
    public class ItemRepository:IItemRepository
    {
        ...
        public PagedList<Item> GetPaginated(PaginateParametrs paginateParametrs)
        {
            return PagedList<Item>.ToPagedList(
                _context.Items
                    .Include(i => i.Accidents).ThenInclude(a => a.Lighting).Include(i => i.Accidents)
                    .ThenInclude(a => a.RoadWay).Include(i => i.Accidents).ThenInclude(a => a.SceneAccident)
                    .Include(i => i.Accidents).ThenInclude(a => a.AccidentType).Include(i => i.Accidents)
                    .ThenInclude(a => a.WeatherCondition).Select(item => new Item 
                    {
                        Id = item.Id,
                ...
                paginateParametrs.PageNumber,
                paginateParametrs.PageSize);
        }
